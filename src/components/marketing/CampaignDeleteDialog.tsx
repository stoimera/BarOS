...
export function CampaignDeleteDialog({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'paused': return 'bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400';
          ...
          <div className="rounded border bg-muted/50 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className={`inline-block mt-1 px-2 py-1 text-xs rounded-full ${getStatusColor(campaign.status)}`}>
                  {campaign.status}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm">
                ...
                <p className="text-blue-700 dark:text-blue-300 mt-1">
                  Deleting this campaign will remove it from your marketing system. This action cannot be undone.
                </p>
              </div>
            </div>
          </div>
